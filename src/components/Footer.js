      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="mb-4">
              <a
                ...
                className="text-gray-400 hover:text-white transition-colors duration-300 flex items-center mb-2"
              >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; 2024 Ayush Raj. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
